...
class UserInfoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var id : String? = sharedPreferences.getString("userId","")
        tv_user_info_id.setText(id)
        var name : String? = sharedPreferences.getString("userName","")
        tv_user_info_name.setText(name)
        var pw : String? = sharedPreferences.getString("userPw","")
        et_user_info_pw.setText(pw)
        var nick : String? = sharedPreferences.getString("nickname","")
    ...
    private fun saveUserInfo(){
        ...
        editor.putString("userPw", et_user_info_pw)
        editor.putString("nickname", et_user_info_nick)
        editor.putString("userTel", et_user_info_tel)
