...
class NoticeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 데이터 생성
        val notices: MutableList<NoticeVO> = mutableListOf()
        notices.add(NoticeVO(R.drawable.notice, "시스템 정기 점검 안내", " 금주 주말에 시스템 정기 점검이 있습니다. \n 작업 시간 동안 시스템 접속이 \n 원활하지 않을 수 있습니다."))
        notices.add(NoticeVO(R.drawable.notice, "새로운 업데이트 알림", "앱이 업데이트되었습니다. \n 새로운 기능과 개선 사항을 확인해보세요."))
        notices.add(NoticeVO(R.drawable.change_circle, "물 수위가 낮음", "물을 채워주시고 \n 오수통을 비워주세요."))
